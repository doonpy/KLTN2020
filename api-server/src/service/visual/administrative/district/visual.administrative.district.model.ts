...
const VisualAdministrativeDistrictSchema: Schema = new Schema(
    {
        ...
        provinceId: { type: Schema.Types.Number, ref: 'visual_administrative_province', autopopulate: true },
    },
...
VisualAdministrativeDistrictSchema.index({ provinceId: 1 }, { name: 'idx_provinceId' });

const VisualAdministrativeDistrictModel = mongoose.model<VisualAdministrativeDistrictDocumentModel>(
