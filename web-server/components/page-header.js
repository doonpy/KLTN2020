...
const PageHeader = () => {
    const { data: sale } = useSWR(`/api/v1/vi/raw-dataset/count-document?transactionType=0`, fetcher);
    const { data: rent } = useSWR(`/api/v1/vi/raw-dataset/count-document?transactionType=1`, fetcher);
